...
async function main (): Promise<void> {
  ...
  if (args.has('help')) {
    console.log([
      ...
      '                        dyke (4, the wall between the farm and the hill)',
      '                        saltings (4, the tidal flat, low and high water)',
      '                        wreck (4, the hull on the low rock, at both ends of a spring tide)',
      '                        quick (1)',
